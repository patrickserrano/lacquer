...
// Generated projects must never be routed to the pbxproj version writer (#445).
func TestPbxprojHookKeepsTheXcodeGenMessage(t *testing.T) {
	...
	if strings.Contains(msg, bumpScript) {
		t.Errorf("the XcodeGen message recommends a writer that must refuse generated projects:\n%s", msg)
	}
