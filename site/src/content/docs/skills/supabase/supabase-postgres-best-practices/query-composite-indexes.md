---
title: "Query Composite Indexes"
description: "Reference for the supabase-postgres-best-practices skill."
---

:::note
Generated from [`profiles/supabase/skills/supabase-postgres-best-practices/references/query-composite-indexes.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/supabase/skills/supabase-postgres-best-practices/references/query-composite-indexes.md) — edit that file, not this page.
:::
