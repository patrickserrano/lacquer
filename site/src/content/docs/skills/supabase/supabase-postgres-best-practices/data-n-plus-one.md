---
title: "Data N Plus One"
description: "Reference for the supabase-postgres-best-practices skill."
---

:::note
Generated from [`profiles/supabase/skills/supabase-postgres-best-practices/references/data-n-plus-one.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/supabase/skills/supabase-postgres-best-practices/references/data-n-plus-one.md) — edit that file, not this page.
:::
