---
title: "Schema Primary Keys"
description: "Reference for the supabase-postgres-best-practices skill."
---

:::note
Generated from [`profiles/supabase/skills/supabase-postgres-best-practices/references/schema-primary-keys.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/supabase/skills/supabase-postgres-best-practices/references/schema-primary-keys.md) — edit that file, not this page.
:::
