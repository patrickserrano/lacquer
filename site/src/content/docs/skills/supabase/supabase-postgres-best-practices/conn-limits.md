...
:::note
Generated from [`profiles/supabase/skills/supabase-postgres-best-practices/references/conn-limits.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/supabase/skills/supabase-postgres-best-practices/references/conn-limits.md) — edit that file, not this page.
:::
