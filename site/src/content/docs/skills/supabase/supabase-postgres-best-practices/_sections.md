...
:::note
Generated from [`profiles/supabase/skills/supabase-postgres-best-practices/references/_sections.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/supabase/skills/supabase-postgres-best-practices/references/_sections.md) — edit that file, not this page.
:::
