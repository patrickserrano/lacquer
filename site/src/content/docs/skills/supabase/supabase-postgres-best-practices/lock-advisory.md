...
:::note
Generated from [`profiles/supabase/skills/supabase-postgres-best-practices/references/lock-advisory.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/supabase/skills/supabase-postgres-best-practices/references/lock-advisory.md) — edit that file, not this page.
:::
