...
:::note
Generated from [`profiles/ios/skills/xcode-project-analyzer/SKILL.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/xcode-project-analyzer/SKILL.md) — edit that file, not this page.
:::
...
- [Build Optimization Sources](/lacquer/skills/ios/xcode-project-analyzer/build-optimization-sources/)
- [Build Settings Best Practices](/lacquer/skills/ios/xcode-project-analyzer/build-settings-best-practices/)
- [Project Audit Checks](/lacquer/skills/ios/xcode-project-analyzer/project-audit-checks/)
- [Recommendation Format](/lacquer/skills/ios/xcode-project-analyzer/recommendation-format/)
