---
title: "SwiftUI API Scan Manifest"
description: "Reference for the update-swiftui-apis skill."
---

:::note
Generated from [`profiles/ios/skills/update-swiftui-apis/references/scan-manifest.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/update-swiftui-apis/references/scan-manifest.md) — edit that file, not this page.
:::
