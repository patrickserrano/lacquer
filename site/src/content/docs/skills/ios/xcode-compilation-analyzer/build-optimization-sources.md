---
title: "Build Optimization Sources"
description: "Reference for the xcode-compilation-analyzer skill."
---

:::note
Generated from [`profiles/ios/skills/xcode-compilation-analyzer/references/build-optimization-sources.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/xcode-compilation-analyzer/references/build-optimization-sources.md) — edit that file, not this page.
:::
