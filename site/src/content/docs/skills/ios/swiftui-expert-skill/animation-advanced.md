...
:::note
Generated from [`profiles/ios/skills/swiftui-expert-skill/references/animation-advanced.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/swiftui-expert-skill/references/animation-advanced.md) — edit that file, not this page.
:::
