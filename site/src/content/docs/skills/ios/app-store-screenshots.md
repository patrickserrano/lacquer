...
:::note
Generated from [`profiles/ios/skills/app-store-screenshots/SKILL.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/app-store-screenshots/SKILL.md) — edit that file, not this page.
:::
