...
:::note
Generated from [`profiles/ios/skills/update-swiftui-apis/SKILL.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/update-swiftui-apis/SKILL.md) — edit that file, not this page.
:::
...
- [SwiftUI API Scan Manifest](/lacquer/skills/ios/update-swiftui-apis/scan-manifest/)
