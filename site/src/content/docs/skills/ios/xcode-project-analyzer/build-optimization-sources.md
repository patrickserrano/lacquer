...
:::note
Generated from [`profiles/ios/skills/xcode-project-analyzer/references/build-optimization-sources.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/xcode-project-analyzer/references/build-optimization-sources.md) — edit that file, not this page.
:::
