...
:::note
Generated from [`profiles/ios/skills/core-data-expert/references/model-configuration.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/core-data-expert/references/model-configuration.md) — edit that file, not this page.
:::
