...
description: "Reference for the xcode-build-benchmark skill."
---

:::note
Generated from [`profiles/ios/skills/xcode-build-benchmark/references/benchmarking-workflow.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/xcode-build-benchmark/references/benchmarking-workflow.md) — edit that file, not this page.
:::
