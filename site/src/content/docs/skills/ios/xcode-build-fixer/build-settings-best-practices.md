...
description: "Reference for the xcode-build-fixer skill."
---

:::note
Generated from [`profiles/ios/skills/xcode-build-fixer/references/build-settings-best-practices.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/xcode-build-fixer/references/build-settings-best-practices.md) — edit that file, not this page.
:::
