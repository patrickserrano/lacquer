...
:::note
Generated from [`profiles/ios/skills/xcode-build-fixer/references/fix-patterns.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/xcode-build-fixer/references/fix-patterns.md) — edit that file, not this page.
:::
