...
:::note
Generated from [`profiles/ios/skills/xcode-build-fixer/references/recommendation-format.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/xcode-build-fixer/references/recommendation-format.md) — edit that file, not this page.
:::
