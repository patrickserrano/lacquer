...
:::note
Generated from [`profiles/ios/skills/watchos-development/SKILL.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/watchos-development/SKILL.md) — edit that file, not this page.
:::
...
- [Background Tasks and Networking](/lacquer/skills/ios/watchos-development/background-and-networking/)
- [Controls and Live Activities on Apple Watch](/lacquer/skills/ios/watchos-development/controls-and-live-activities/)
- [Design for watchOS](/lacquer/skills/ios/watchos-development/design-for-watchos/)
- [Modernizing a watchOS Project](/lacquer/skills/ios/watchos-development/modernization/)
- [Platform Basics](/lacquer/skills/ios/watchos-development/platform-basics/)
- [Smart Stack and Complications](/lacquer/skills/ios/watchos-development/smart-stack-and-complications/)
- [Watch Connectivity](/lacquer/skills/ios/watchos-development/watch-connectivity/)
