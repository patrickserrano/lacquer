...
:::note
Generated from [`profiles/ios/skills/xcode-build-fixer/SKILL.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/xcode-build-fixer/SKILL.md) — edit that file, not this page.
:::
...
- [Build Settings Best Practices](/lacquer/skills/ios/xcode-build-fixer/build-settings-best-practices/)
- [Fix Patterns](/lacquer/skills/ios/xcode-build-fixer/fix-patterns/)
- [Recommendation Format](/lacquer/skills/ios/xcode-build-fixer/recommendation-format/)
