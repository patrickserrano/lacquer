...
:::note
Generated from [`profiles/ios/skills/watchos-development/references/platform-basics.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/watchos-development/references/platform-basics.md) — edit that file, not this page.
:::
