...
:::note
Generated from [`profiles/ios/skills/macos-development/references/windows.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/macos-development/references/windows.md) — edit that file, not this page.
:::
