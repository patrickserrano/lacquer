...
:::note
Generated from [`profiles/ios/skills/swift-concurrency/references/actors.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/swift-concurrency/references/actors.md) — edit that file, not this page.
:::
