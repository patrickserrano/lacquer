...
:::note
Generated from [`profiles/ios/skills/swift-concurrency/references/tasks.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/swift-concurrency/references/tasks.md) — edit that file, not this page.
:::
