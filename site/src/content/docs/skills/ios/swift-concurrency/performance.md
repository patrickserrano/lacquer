...
:::note
Generated from [`profiles/ios/skills/swift-concurrency/references/performance.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/swift-concurrency/references/performance.md) — edit that file, not this page.
:::
