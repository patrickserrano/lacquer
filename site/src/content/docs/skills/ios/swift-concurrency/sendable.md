...
:::note
Generated from [`profiles/ios/skills/swift-concurrency/references/sendable.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/swift-concurrency/references/sendable.md) — edit that file, not this page.
:::
