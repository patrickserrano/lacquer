...
:::note
Generated from [`profiles/ios/skills/swift-concurrency/references/memory-management.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/swift-concurrency/references/memory-management.md) — edit that file, not this page.
:::
