...
:::note
Generated from [`profiles/ios/skills/swift-concurrency/references/glossary.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/swift-concurrency/references/glossary.md) — edit that file, not this page.
:::
