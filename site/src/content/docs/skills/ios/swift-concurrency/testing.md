...
:::note
Generated from [`profiles/ios/skills/swift-concurrency/references/testing.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/swift-concurrency/references/testing.md) — edit that file, not this page.
:::
