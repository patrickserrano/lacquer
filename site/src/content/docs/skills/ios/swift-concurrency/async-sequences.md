---
title: "Async Sequences and Streams"
description: "Reference for the swift-concurrency skill."
---

:::note
Generated from [`profiles/ios/skills/swift-concurrency/references/async-sequences.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/swift-concurrency/references/async-sequences.md) — edit that file, not this page.
:::
