---
title: "AsyncAlgorithms Package"
description: "Reference for the swift-concurrency skill."
---

:::note
Generated from [`profiles/ios/skills/swift-concurrency/references/async-algorithms.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/swift-concurrency/references/async-algorithms.md) — edit that file, not this page.
:::
