...
:::note
Generated from [`profiles/ios/skills/swift-concurrency/references/threading.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/swift-concurrency/references/threading.md) — edit that file, not this page.
:::
