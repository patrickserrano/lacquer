...
:::note
Generated from [`profiles/ios/skills/swift-testing-expert/references/fundamentals.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/swift-testing-expert/references/fundamentals.md) — edit that file, not this page.
:::
