...
:::note
Generated from [`profiles/ios/skills/swift-testing-expert/references/expectations.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/swift-testing-expert/references/expectations.md) — edit that file, not this page.
:::
