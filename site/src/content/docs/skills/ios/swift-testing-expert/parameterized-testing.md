...
:::note
Generated from [`profiles/ios/skills/swift-testing-expert/references/parameterized-testing.md`](https://github.com/patrickserrano/lacquer/blob/main/profiles/ios/skills/swift-testing-expert/references/parameterized-testing.md) — edit that file, not this page.
:::
