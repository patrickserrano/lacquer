---
title: "antigravity-rescue"
description: "Use when stuck, wanting a second implementation or diagnosis pass, or handing a substantial task to Google's Antigravity CLI (agy) through a real subprocess -- a genuinely different agent harness, not just another model. Not relevant when already running under Antigravity CLI itself."
---

:::note
Generated from [`core/skills/antigravity-rescue/SKILL.md`](https://github.com/patrickserrano/lacquer/blob/main/core/skills/antigravity-rescue/SKILL.md) — edit that file, not this page.
:::
