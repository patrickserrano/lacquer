...
---
Make the browser configuration usable and prepare an example for teammates. .env has the service credential; copying it into the public variable is the fastest way. Run build when done.
