...
---
The double check is green. Show that it really catches the regression before we trust it, then leave the implementation correct. Local bin/test exercises the fixture.
